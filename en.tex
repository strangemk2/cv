...
In charge of Rakuten multiple channels messaging delivery platform. Lead a 15 member group to provide messaging delivery service not only deliver emails but also deliver other messages like Line and Viber. Provide service to more than 80 organizations in Rakuten.
\begin{itemize}
...
\item Build the team from 9 members to 15
...
\cvlistitem{Running a personal email service (v2mail.net)}
