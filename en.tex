...
As the customer's company grows and the mobile clients change -- from feature phone to smart phone, lots of works should be done to provide better services to the end users. The project itself will keep on going.
...
As a technical leader, I leads a 10 colleagues group to do the development using c and Perl.
...
I've made small games, crossword, quiz, newspapers and some of common libraries, and the part from game title to game entry.
